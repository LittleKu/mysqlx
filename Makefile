...
OBJECTS = mysql/MyBasicResults.cpp mysql/MyBoundResults.cpp mysql/MyDatabase.cpp mysql/MyDriver.cpp mysql/MyStatement.cpp main.cpp
...
INCLUDE += -I. -I.. -I$(MYSQL)/include -I./mysql -I$(AMTL)/include
LINK += -m32 -lm -ldl -lz -lpthread -lrt
LINK += $(MYSQL)/lib/libmysqlclient_r.a
